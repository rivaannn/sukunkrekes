...
$result = mysqli_query($connect, $sql);
 ?>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">SUKUN KREKES</a>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <a class="btn btn-light btn-xl js-scroll-trigger" href="login.php">Ayo Pesan!</a>
        </div>
      </div>
    </div>
    <br /><br /><br /><br />
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto text-center">
          ...
          <a class="d-block" href="sukunkrekes@gmail.com">sukunkrekes@gmail.com</a>
        </div>
      </div>
    </div>
  </section>
